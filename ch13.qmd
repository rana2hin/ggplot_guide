...
<i>You can also use `geom_text()` if you don't like boxes around your labels. Expand to see example.</i>
...
```{r label-facet-single, warning=FALSE, message=FALSE}
ann <- data.frame(
  o3 = 30,
  temp = 20,
...
```{r ggtext-geom-richtext-html, warning=FALSE, message=FALSE}
